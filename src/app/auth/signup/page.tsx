 ...
 * Fields: nickname, gender, province, email, password
 * Note: Email verification skipped when email provider is not configured
 */
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-8">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-text-muted mt-2">创建你的账号，免费开始体验</p>
          </div>
