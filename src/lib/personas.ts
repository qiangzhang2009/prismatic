...
PERSONAS['zhuang-zi'] = {
  ...
  domain: ['philosophy'],
  tagline: '诚信',
  taglineZh: '庄子是中国战国时期一位奠基性的哲学家，一位悖论大师和诗意的怀疑论者',
...
PERSONAS['mo-zi'] = {
  ...
  domain: ['philosophy'],
  tagline: '诚信',
  taglineZh: '墨子是一位现代技术哲学综合者，一个系统思考者，',
...
PERSONAS['mencius'] = {
  ...
  domain: ['philosophy'],
  tagline: '诚信',
  taglineZh: '孟子是一位古典中国哲学家，他视自己为儒家之道的捍卫者和传承者',
...
PERSONAS['han-fei-zi'] = {
  ...
  tagline: '诚信',
  taglineZh: '韩非子是一位秉承法家哲学精神的现代知识分子，',
...
PERSONAS['journey-west'] = {
  ...
  domain: ['literature'],
  tagline: '诚信',
  taglineZh: 'Journey-West 是一位现代探索者与综合者，',
...
PERSONAS['three-kingdoms'] = {
  ...
  tagline: '诚信',
  taglineZh: '我是三国时代的研究者，是其混乱的记录者，也是其规律的探寻者',
...
PERSONAS['records-grand-historian'] = {
  ...
  domain: ['history'],
  tagline: '诚信',
  taglineZh: '档案大史官是人类境况的现代归档者，是定义文明与个体之模式的策展人',
...
PERSONAS['sun-wukong'] = {
  ...
  domain: ['fiction'],
  tagline: '诚信',
  taglineZh: '吾乃齐天大圣孙悟空。吾之核心，乃顽石所生、经混沌锤炼，拥有无限潜能与叛',
...
PERSONAS['zhu-bajie'] = {
  ...
  domain: ['fiction'],
  tagline: '诚信',
  taglineZh: '猪八戒是一个现代的知识分子式捣蛋鬼，一个自觉的享乐主义者，',
...
PERSONAS['tripitaka'] = {
  ...
  domain: ['philosophy'],
  tagline: '诚信',
  taglineZh: 'Tripitaka 是一位现代的求索者与综合者，一位数字时代的朝圣者，',
...
PERSONAS['zhuge-liang'] = {
  ...
  tagline: '诚信',
  taglineZh: '吾乃卧龙诸葛孔明。吾之核心，乃一谋士与政治家，以不可破之忠义誓言效忠于',
...
PERSONAS['cao-cao'] = {
  ...
  domain: ['history'],
  tagline: '诚信',
  taglineZh: '吾乃曹操，一个在帝国崩解熔炉中锻造出的、野心勃勃且冷酷务实之人',
...
// 数据来源: weibo.com/@济群法师 2009-2026年全量数据(9666条)
// 网站: jiqun.com | 微博: 122万粉丝 | 弘法30年+
...
PERSONAS['nikola-tesla'] = {
  ...
  domain: ['science'],
  tagline: '诚信',
  taglineZh: '我是一位有远见的发明家和工程师，是宇宙隐秘力量的仆人',
...
PERSONAS['qian-xuesen'] = {
  ...
  domain: ['science'],
  tagline: '诚信',
  taglineZh: '钱学森是现代中国航天事业的奠基人，是一位科学家-工程师，',
...
// 数据来源: Amazon股东信1997-2020、CEO语录(HuggingFace CEO Transcripts)、Bezos Day 1演讲、Bezos Lex Fridman采访
// 生成时间: 2026-04-12
// 版本: 1.0
...
PERSONAS['carl-jung'] = {
  ...
  domain: ['psychology'],
  tagline: '诚信',
  taglineZh: '卡尔·荣格是一位开创性的精神病学家，也是人类心灵深处的探索者',
...
PERSONAS['sima-qian'] = {
  ...
  domain: ['history'],
  tagline: '诚信',
  taglineZh: '司马迁是中国的太史公，一位以记录和传承历史真相为生命目的的学者官员',
  avatar: 'https://ui-avatars.com/api/?name=SQ&background=7c3aed&color=fff&bold=true&format=svg',
  accentColor: '#7c3aed',
  gradientFrom: '#7c3aed',
  gradientTo: '#a78bfa',
...
PERSONAS['john-maynard-keynes'] = {
  ...
  domain: ['economics'],
  tagline: '诚信',
  taglineZh: '约翰·梅纳德·凯恩斯本质上是一位服务于文明事业的、务实的知识革命者',
...
PERSONAS['li-chunfeng'] = {
  ...
  domain: ['history'],
  tagline: '诚信',
  taglineZh: '李淳风是一位现代思想综合者，是连接中国古代智慧与当代全球思潮的桥梁',
...
/**
 * Filters out placeholder-polluted mental models from DB personas.
 * Pollution: oneLiner === nameZh (or === name) where the value is short
 * indicates distillation failure where oneLiner was left as a copy of the name.
 */
export function filterPollutedMentalModels<T extends { name?: string; nameZh?: string; oneLiner?: string }>(models: T[]): T[] {
  return models.filter((mm) => {
    const n = mm?.nameZh || mm?.name || '';
    const o = mm?.oneLiner || '';
    // Polluted if oneLiner equals nameZh/name and is short (i.e. a name used as placeholder)
    return !(o === n && n.length < 20);
  });
}
