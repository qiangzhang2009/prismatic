...
 	 			 	
     Das Buch behandelt die philosophischen Probleme und zeigt – wie ich glaube – daß die Fragestellung dieser Probleme auf dem Mißverständnis unserer Sprachlogik || der Logik unserer Sprache beruht. – Man könnte den ganzen Sinn des Buches etwa in die Worte fassen: Was sich überhaupt sagen läßt, läßt sich klar sagen; und wovon man nicht reden kann, darüber muß man schweigen.
...
 	 			 	
     Wenn diese Arbeit einen Wert hat, so besteht er in zweierlei. Erstens darin, daß in ihr Gedanken ausgedrückt sind, und dieser Wert wird umso größer sein, je besser die Gedanken ausgedrückt sind. Je mehr der Nagel auf den Kopf
II
getroffen ist. – Hier bin ich mir bewußt, weit hinter dem Möglichen zurückgeblieben zu sein. Einfach darum, weil meine Kraft zur Bewältigung der Aufgabe zu gering ist. – Mögen andere kommen und es besser machen.
...
* [Die Dezimalzahlen als Nummern der einzelnen Sätze deuten das logische Gewicht der Sätze den Nachdruck an || an, den Nachdruck, der auf ihnen in meiner Darstellung liegt. Die Namen || Sätze n˙1, n˙2, n˙3 etc. sind Bemerkungen zum Satze № n; die Sätze n˙m1, n˙m2, etc. Bemerkungen zum Satze № n˙m, und so weiter.]
		
 	 			 	
– 2 –
2.01231
Um einen Gegenstand zu kennen, brauche || muß ich zwar nicht seine externen-, aber ich muß alle seine internen Eigenschaften kennen.
...
 	 			 	
2.02331
Entweder ein Ding hat Eigenschaften, die kein anderes hat, dann kann man es ohne weiteres durch eine Beschreibung aus den anderen herausheben, und darauf hinweisen; oder aber, es gibt mehrere Dinge, die ihre sämtlichen Eigenschaften gemeinsam haben, dann ist es überhaupt
– 3 –
...
 	 			 	
2.062
Aus dem Bestehen oder Nichtbestehen des Einen kann nicht auf das Bestehen oder Nichtbestehen des Anderen || eines Sachverhaltes, kann nicht auf das Bestehen oder Nichtbestehen eines anderen geschlossen werden.
...
 	 			 	
2.1
Die Tatsachen begreifen wir in Bildern. || Wir machen uns Bilder der Tatsachen.
...
 	 			 	
3.1
Der Gedanke drückt sich im Satz || Im Satz drückt sich der Gedanke sinnlich wahrnehmbar aus.
...
Zwei Zeichen, ein Urzeichen, und ein durch Urzeichen definiertes, können nicht auf dieselbe Art und Weise bezeichnen. Namen kann
– 8 –
man nicht durch Definitionen auseinanderlegen. (Kein Zeichen, welches allein, selbständig eine Bedeutung hat.)
...
 	 			 	
3.323
In der Umgangssprache kommt es ungemein häufig vor, daß dasselbe Wort auf verschiedene Art und Weise bezeichnet – also verschiedenen Symbolen angehört –, oder doch, daß zwei Wörter, die auf verschiedene Art und Weise bezeichnen, äußerlich in der gleichen Weise im Satze angewandt werden.
...
– 10a –
des Satzzeichens herrühren. Wesentlich diejenigen, welche allein den Satz befähigen, seinen Sinn auszudrücken.
...
Und so verhält es sich in der ganzen Philosophie || Philosophie überhaupt: Das Einzelne erweist sich immer wieder als unwichtig, aber die Möglichkeit jedes Einzelnen gibt uns einen Aufschluß über das Wesen der Welt.
...
 	 			 	
4
Der Gedanke ist der sinnvolle Satz.1
...
Die Sprache verkleidet den Gedanken. Und zwar so, daß man nach der äußeren Form des Kleides, nicht auf die Form des bekleideten Gedankens schließen kann; weil die äußere Form des Kleides nach ganz anderen Gesichtspunkten || Zwecken gebildet ist, als nach dem || danach, die Form des Körpers erkennen zu lassen.
...
Und es ist nicht verwunderlich, daß die tiefsten Probleme die sind, die eigentlich keine Probleme sind.
...
(Wie im Märchen die zwei Jünglinge, ihre zwei Pferde und ihre Lilien. Sie sind alle im gemeinsamen || in gewissem Sinne Eins.)
...
(Und das Wörterbuch übersetzt nicht nur Substantiva, sondern auch Zeit-, Eigenschafts- und Bindeworte || in Bindewörter etc.; und es behandelt sie alle gleich.)
...
Man kann geradezu sagen: Statt || statt, dieser Satz hat diesen und diesen Sinn; dieser Satz stellt diese und diese Sachlage dar.
...
 	 			 	
4.0312
Die Möglichkeit des Satzes basiert || beruht auf dem Prinzip der Vertretung von Gegenständen durch Zeichen.
...
(Auch der Satz „ambulo” ist zusammengesetzt, denn sein Stamm ergibt mit einer anderen Endung, und seine Endung mit einem anderen Stamme || Stamm, einen anderen Sinn.)
...
Wollten wir es durch einen Index „a” anzeigen – etwa so: „f(xaa)” – es würde auch nicht genügen – wir wüßten nicht den Bereich der Allgemeinheitsbezeichnung.
Wollten wir es durch Einführung einer Marke in die Argumentstellen versuchen – etwa so: „(A, A).F(A, A) – es würde nicht genügen – wir könnten die Identität der Variablen nicht feststellenu.s.w. || . U.s.w.
...
 	 			 	
4.05
Die Wirklichkeit wird mit dem Satz verglichen.3
...
 	 			 	
4.063
Ein Bild zur Erklärung des Wahrheitsbegriffes: Schwarzer Fleck auf weißem Papier; die Form des Fleckes kann man beschreiben, indem man für jeden Punkt der Fläche angibt, ob er weiß oder schwarz ist. Der Tatsache, daß ein Punkt schwarz ist, entspricht eine positive-, der,
– 15 –
daß ein Punkt weiß (nicht schwarz) ist, eine negative Tatsache. Bezeichne ich einen Punkt der Fläche (einen Frege'schen Wahrheitswert), so entspricht dies der Annahme, die zur Beurteilung aufgestellt wird etc. etc.
...
 	 			 	
4.116
Alles was überhaupt gesagt || gedacht werden kann, kann klar gedacht werden. Alles was sich aussprechen läßt, läßt sich klar aussprechen.
...
 	 			 	
4.1211
So zeigt ein Satz „f(a)”, daß in seinem Sinn der Gegenstand a vorkommt, die || zwei Sätze „fa” und „ga”, daß in ihren Sinnen derselbe Gegenstand vorkommt. || ihnen beiden von demselben Gegenstand die Rede ist.
Zwei Sätze, welche einander widersprechen, zeigen dies; ebenso zeigt es sich in den Sätzen, wenn einer auf den || Wenn zwei Sätze einander widersprechen, so zeigt dies ihre Struktur; ebenso, wenn einer aus dem anderen folgtu.s.w. || . U.s.w.
...
 	 			 	
4.1213
Jetzt verstehen wir auch unser Gefühl, || : daß wir im Besitze einer richtigen logischen Auffassung sind, || seien, wenn nur einmal alles in unserer Zeichensprache stimmt.
...
(Statt Eigenschaften || Eigenschaft der Struktur sage ich auch „interne Eigenschaft”; statt Relation der Strukturen „interne Relation”.
...
(Hier entspricht dem schwankenden Gebrauch des Wortes || der Worte „Eigenschaft” und „Relation” der schwankende Gebrauch des Wortes „Gegenstand”.)
		
 	 			 	
4.124
Das Bestehen einer internen Eigenschaft einer möglichen Sachlage wird nicht durch einen Satz ausgedrückt, sondern es drückt sich in dem sie darstellenden Satz, durch eine interne Eigenschaft des || dieses Satzes aus.
Es wäre ebenso unsinnig, dem Satze eine formale Eigenschaft zuzusprechen, als sie ihm abzusprechen.
		
 	 			 	
4.1241
Formen kann man nicht dadurch von einander unterscheiden,¤ daß man sagt, die eine habe diese, die andere aber jene Eigenschaft; denn dies setzt voraus, daß es einen Sinn hätte || habe, beide Eigenschaften von beiden Formen auszusagen.
...
(Steht b in einer dieser Beziehungen zu a, so nenne ich es || b einen Nachfolger von a.)
– 18 –
...
Sie alle bezeichnen formale Begriffe und werden in der Begriffsschrift durch Variable, nicht durch Funktionen oder Klassen dargestellt. (Wie Russell glaubte. || Frege und Russell glaubten.)
...
 	 			 	
Der formale Begriff ist mit einem Gegenstand, der unter ihn fällt, bereits gegeben. Man kann also nicht Gegenstände eines formalen Begriffs und den formalen Begriff selbst als Grundbegriffe einführen. Man kann also z.B. nicht den Begriff der Funktion, und auch spezielle Funktionen (wie Russell) als Grundbegriffe einführen; oder den Begriff der Zahl und bestimmte Zahlen.
...
(Man kann also z.B. nicht fragen: „Gibt es unanalysierbare Subjekt-Prädikatsätze?”)5
...
Den Elementarsatz schreibe ich als Funktion der Namen in der Form: „f(x)”, „g || φ(x,y)”, etc.
...
(Führe ich durch eine Gleichung ein neues Zeichen „b” ein, indem ich sage || bestimme, es solle ein bereits bekanntes Zeichen „a” ersetzen, so schreibe ich die Gleichung – Definition – (wie Russell) in der Form „a = b Def”.) || Die Definition ist eine Zeichenregel.)
...
 	 			 	
4.243
Können wir zwei Namen verstehen, ohne zu wissen, ob sie dasselbe Ding oder zwei verschiedene Dinge bezeichnen? – Können wir einen Satz, worin
– 20 –
zwei Namen vorkommen, verstehen, ohne zu wissen, ob sie Dasselbe oder Verschiedenes bedeuten?
...
 	 			 	
4.244
Ausdrücke wie „a = a”, oder von diesen abgeleitete, welche dem obigen zu widersprechen scheinen, sind weder Elementarsätze, noch sonst sinnvolle Zeichen. (Dies wird sich später zeigen.)
		
 	 			 	
4.25
Ist der Elementarsatz wahr, so besteht der Sachverhalt; ist der Elementarsatz falsch, so besteht der Sachverhalt nicht.6
...
– 22 –
(Frege's Zeichen || „Urteilsstrich” „⊢” ist logisch ganz bedeutungslos; es zeigt bei Frege (und Russell) nur an, daß diese Autoren die so bezeichneten Sätze für wahr halten. „⊢” gehört daher ebenso wenig zum Satzgefüge wie etwa die Nummer des Satzes. Ein Satz kann unmöglich von sich selbst aussagen, daß er wahr ist.)
...
Die Tautologie läßt der Wirklichkeit den ganzen – unendlichen – logischen Raum; die Kontradiktion erfüllt den ganzen logischen Raum und läßt der Wirklichkeit keinen Punkt. Keine von beiden kann daher die Wirklichkeit irgend wie || irgendwie bestimmen.
...
 	 			 	
4.51
Angenommen, mir wären alle Elementarsätze gegeben: Dann läßt s