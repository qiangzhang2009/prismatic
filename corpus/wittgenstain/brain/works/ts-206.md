...
            The way out of all these troubles is to see that neither Q(x,y),
although
also
it is a very interesting function, nor any propositional function whatever, can be substituted for x = y.
