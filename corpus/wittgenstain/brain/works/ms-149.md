...
Ms 149. 
Wittgenstein Nachlass Ms-149 [so-called C5] (WL) 
 Ludwig Wittgenstein
 ...
 Øystein Hide, William Boos transcription in MECS-WIT markup: 1998, 1999
 ...
 http://wab.uib.no/cost-a32_xml/Ms-149_OA.xml
 
 Wittgenstein Archives at the University of Bergen (WAB)   Bergen 
  http://www.wittgensteinsource.org/Ms-149_n  
  http://www.wittgensteinsource.org/Ms-149_d 
  http://www.wittgensteinsource.org/Ms-149_f
 ...
 1
		    ...
		    Continuation from Ms-148,48v.  … it wrongly on some occasion? 
		  Mustn't  I say he was mistaken?” 
 Why should I say this & not rather, he has forgotten the
 ...
 ​  
 I can for what I see 1 use the impersonal form of
 description & the fact that I say “for what I see”
 doesn't say at all that after all this is only a disguised
 personal description! 
 For I just expressed my self myself in
 our English. ordinary form of
 expression. For I just expressed myself in
 ...
 Unregelmäßige was ich sehe, wenn ich ihn von einer
 Kant Ecke aus sehe? 
 ...
 ​ 
 What's the difference between me being angry and some
he  being angry?
 ...
 similar.) 
 I might therefore naturally objecktt to this way
 of expression. 2
 ...
 If I write down my own experiences nothing is more natural than to refer
  toby ‘I’ only to my body or
 L.W.'s body
 as opposed to other bodies, but not to to distinguish my
 ...
 ‘I see’ when the other man saiys it.
 ...
 gesprochen hat. 
 Ich habe einen gezeigt,. weil es
 nicht 

 

 ​
 “Aber woher weiß ich daß ich gesprochen habe wenn
 ...
 the other man it shows draws his attention to a
 ...
 I could write say a tex book on Physics in
 ...
 We must make be mislead in a queer way!
 ...
 neighbour. 
 “But somehow our language doesn't B bring
 it out, that there is something unique namely real present experience,
 & do you just wish to advise me to resign myself to
 that?”
 ...
 ​ 
 How is it that the Auszeichnung we I
 might propose for those sentences which describe my own personal
 experience does do not really quite satisfy
 usme?
 ...
 ​
 Now imagine this: as soon as he ⇄ even he ⇄ even he ⇄ even even he has learnt enought of language to
 1 be able to say so express
 it he tells us that he saw blue when he said is not
 ⇄ red is not
 ⇄ red is red Not ‘Is not
 red’.
 ...
 Augustine, about expressing
 what the wishes inside him.

 

 ​
 Why shouldn't we consider the case that the child learns
 to think & always dreams that it had a private language before it learnt
 ours. 
 ...
 Ellipse gesehen”, oder so stellt er den folgenden Tag
 einen Kreis dar”.
 ...
 mich daß er mir einen dümmlichen Eindruck gemacht hat.”] 
 ...
 where … ” ist this: We take it as the
 criteriumon for that my
  meaning meaning the same by
 ‘red’ as the other people we
 do that as a rule I he argues with
 them us in giving the same names to the colours
 of objectss as they we do. 
 ...
 It is further kclear that even before ever finding such a cause
 ...
 ​
 N Consider now this case:
 Someone says I remember yesterday having seen everything red
 green & vice versa. 
 Consider this case: someone saiys
 it's queer I can't
 underst. I see everything
 red green blue today & vice versa. 
 We answer: it must look queer! 
 He saiys it does & e.g.
 goes on to say how cold the glowing coleal
 looks & how warm the clear (blue) sky. 
 I think we should under these or similar
 circumst. be
 incl. to say that he saw red what we saw
  greenblue. 
 ...
 s.o.. 
 We say it must have We say: But you called the
 ...
 ​
 Suppose Case of contradictory memory images. 
 tTomorrow he remembers this, the day after
 tomorrow something else.

 

 ​ 
 The whole trend, to show that  the expression “letting one look  into
 his soul” is often misleading.

 

 ​
  Back to the example of the afterimages or №  1. 
 We can say that these cases are not cases of
 communic. of personal
 exp. if there were no
 pers. exp.
 ...
 And here the answer seems to be that for 
 ...
 paradigme of red & such like. 
 On the other hand you just intently stare at the red thing.

 

 ​ 
 In many part of their uses the
 words expressions ‘visual
 image’ & ‘picture’ run parallel but where
 where they don't the analogy which does
 exists tends to delude us. 
 taut. 
 ...
 same as saying that one sees something but the senses of these 
 expressions are closer related than it might appear to you. 
 
 We say a blind man does not  see anything. 
 But not only do we say so but he too saiys that he
 does not see. 
 ...
 have. 
 Now whome do we call blind, what is our
 criteriumon for blindness? 
 A certain kind of behaviour. 
 And if a the person behaves in that particular
 ...
 isn't just a behaviour; it's clear that an
 man can behave like a blind man & not be blind. 
 Therefore ‘blindness’ means something
 different: in fact something this behaviour only helps him
 7
  to
 understand what we mean by
 ‘blindness’. 
 The outward circumstances are what both we & ⇄ he we & ⇄ he he & we 
 know. 
 ...
 all these cases & thereby knows so
 concludes that we mean this experience of his by saying that he sees
 nothing”. 
 The idea is that we teach a man person the meaning
 of expressions relating to personal experiences
 indirectely. – 
 Such an indirect mode of teaching we could imagine as
 follows. 
  № )
 We I teach a child the names of colours
 & a game, say, of bringing objects of a certain colour if when
 the ‘name of the colour’ is called out. 
 I We don't however teach him the colournames
 by pointing to a sample which we both see  // which both of
 us see //  which I  & he see saying
 e.g. the word ‘red’.
 
 but Instead we let him look at a white
 wall sheet of paper through various a pair
 of spectacles which if we look through them make us see the paper
 red & we say the word ‘red’ whenever we put these
 spectacles on his nose. I have various spectacles each of which when
 we I look through it makes
 us me see the white paper in a different
 colour. 
 These spectacles are also distinguished by their
 
  outside
 appearance: the red one that makes me
 see red has round circular glasses
 the green another one elliptical
 ones etc. 
 IWe now teach the child in this way that when I see it
 looking through the putting the
 round circular ones on his nose I say the word
 ‘red’, etc. when the
 elliptical ones ‘green’ & so
 forth. 
 This one might call teaching the child the meanings of the
  colournames in an indirect way because I one could
 ...
 And this way is indirekct as opposed to the direkct
 ...
 And what is so misleading to us about when we consider this use is
 ...
 seeing is one process & expressing that we see an
 other another, & all they have to do with each other is
 that they sometimes coincide; they have the same connection as being red
 & being sweet. 
 Sometimes what is red is sweet, etc.” 
 ...
 expression words ‘seeing red’
 in such 1 a way that we can say “he A sees
  …  red he sees  …  A sees
 red, but doesn't show it” on the other hand
 it is easy to see that we would have no use for these words if their
 application was severed from the criteria which in of behaviour,
 ...
 showing what  
  ...
  they see,
 & also that  sometimes under certain
 ...
 mean. 
 What is the criteriumon for his connecting
 ...
 Is it not often just that he calls it red? 
		 ...
		 process certain (private) experience or
		  ...
		  (mental) event fact in the realm of primary
 ...
 ​  
 In fact if he spi is to play a
 lang. games the possibility of
 this will depend upon his own & the other people's
 reactions. 
 For The game depends upon the agreement of these reactions
 i.e. they must
 call describe the same things
 ‘red’. 
 “But s if he speaks to himself surely this is
 different. 
 For then he needn't consult other people's
 reactions & what he calls red is
 just what just he just gives the name
 ‘red’ now to  he just gives the name
  ‘red’ now to the same colour as
 that to which he called 
 9
  gave it
 ...
 call sameness of colour & so on ad inf.? 
 It is quite true he uses connects, in agreement with
 ordinary use, the word ‘red’ & the same
 colour such that he would not say that he saw now the colour he had seen
 ...
 The words “‘seeing red’ means a part
  experience” are useless senseless  unless we can follow them up by:
 ...
 ​ 
 (Still contradicting objecting)But I
 could use language just for making entries in my diary & without
 even having learnt it I could have invented a name for 
  the particular a
  colour sensation say the name ‘red’ & then
 ...
 a red colour, or looking at a red object, or such
 like (which supply the ‘namely this’),
 but how do you make use make use of the expression
 & the experience you thus connect with it? 
 For how you say what we call the meaning of the word lies in the
 game we play with it.

 

 ​ 
 But it seems too me that I either see red or don't see
 red. 
 Whether I say express it or not. 
  Picture we use here. 
 ...
 10
  jumping
 another”. 
 But here there is a supplement to this statement
 ...
 see’ except t showing that I see. 
 ...
 ← But an ostensive def. is not a
 magic act of conjury. 
  If I explain to someone to the use of ‒ ‒ ‒ by ‒ ‒ ‒ 
 TGiving the o.
 d. simply consists in ‒ ‒ ‒. 
 One might be inclined to say that castling was not just the act of
  … . 
 But it is the game of wh which it is
 part … . 
 Thus So what does giving to myself the ostensive
 def. of red consist in? 
 ...
 that should necessarily be what the others
     understand mean by seeing red.
   
     The first vers. I don't like I assume that the others
      knows know have what the
   ...
   So I shwould rather leave it open what colour I am
 ...
 describ said “he sees a same colour, say,
 blue & saiys ‘I see
 red.’”.) 
...
Consider the prop.: He makes
 ...
 yourself a sample you say to yourself ‘seeing red is
 this’ but you don't because the usual criteria
  for the sameness of the sample don't
 apply. 
 I can say I call ‘red’ always the same
 colour or I whenever I explain red I point to a sample of the same
 colour.

 

 ​  
 Isn't If we describe a game which he plays
 with himself is it relevant that he should use the word red
 to for the same colour in our sense or would we also call it
 a lang. game if he used it anyhow. 
 Then what is the criteriumon for using it in the same
 way? 
 ...
 ​   So he can make sure  he
 did of what it means in this private way
  by having a priv.
 sens.’! 
  
  of what it
   means in this private way! by having a priv.
    sens. in this private way of what it
    means!
 ...
 future case. 
 Now what if I see a colour again, can I say I knew made sure I knew
 ...
 zu wissen, daß ich Zahnschm. habe,
 sondern, daß mir mein Benehmen gar nichts sagt. 12
 ...
 just as correct as “I sent him to the d
 ...
 tial that the same meaning is kept in throughout a
 game.
 ...
 And are you also recognizing the meaning of the word  the
 ...
 its  meaning on me so as not to forget it later
 on”. 
 ...
 ​ 
 What's the use here of being sure of it if it
 doesn't follow that it is so & if your being sure is the
 only criterion there is to for it being
 so? 
 ...
 for the cause (of it) of the change & find, say, that something's come off the
 body,. 
 or that 1 the body has in some way   
 ...
 has toothache’? 
 Is it the saying the words “A has
 t.”? 
 ...
 that we have t.. 
 Therefore even if we have no ground to for assuming that
 anyone else has t. we may nevertheless
 know that we have.” 
 But would we in this case at all talk of a 
 
 
 (particular) behaviour as a symptom of pains? 
 “Suppose no one knew pains & I just
 w except I, & I just invented a name
 ‘abracadabra’ for it!”
 ...
 ​ 
 Certain behaviour under cert.
 circumst. we call showing our
 t. other behaviour, hiding our
 t.. 
 ...
 Supposing The question is: do I consider it
 incomplete? 
 If so I will pe distinguish between two cases of my
 ...
 ‘t.’ has a meaning
 entirely independent of a behaviour show connected with
 t..”  15
 ...
 Nnumber but what have I bay
 theseis act of ‘definition’ given the name a
 use?
 ...
 t. is” I answer yes after having
 brought before my mind a certain sensation.” 
 But now is this certain sens.
 characterised? 
 ...
 already in what sort of a game this name is going to be used.
 ...
 that he has 16
  ...
  pain although I have no reason
  whatever for it?
  
  tTo
   any part use of the word.  
 I kcan say “I assume … ”,
 ...
 assume say that there is one which I
 ...
 ​  
 The role of In our priv.
 lang. game we had, it seemed, given a name to
 an impression, – in order, of course, to use
 it the name for this
 imp. in the future. 
 The def.,
 that is, should have determined on future
  occasions for what impr. to use the
 word ‘red’ name & for
 which not to use it. 
 Now we said that on certain occ.
  
  
 we were incl.

  after having given the def.  
   
 we did use thies word and on
 others 
  
  we
   didn't not; but we refused
 to described these 
 
 occ. only by saying that we had
 ‘certain impr.’ that is
 we didn't describe them at all. 
 The only thing that characterized them was that we used such
 & such words. 
 What seemed in this lang.
 game to be a definition didn't play the role of a
 def. at all, it did not justify one subsequently use
 of the word and all that remains of
 our your one's
 priv. lang.
 game is therefore that I you sometimes without
 justifying my part. reason
 write a word the word ‘red’
 ...
 ‘red’ although I don't thing think
 ...
 any some arbitrary word in the place of the name
 of the colour’. 
 ...
 this colour”. 
 We certainly may be inclined to say this sentence on certain occasions but it would
 be wrong to say that therefore we had a feeling of fitting whenever
 ...
 game of chess? 
 Any Just anything? – 
 I suppose Would you just say he must
 go through certain private experiences but that's as
 good which I can (only) indirectly describe by saying that
 ...
 then that he imagines certain mooves
 etc.. 
 And on being if you were asked what
 does it means to imagine a chessboard, you would
 explain it by pointing to a real chessboard or,
 the say to a picture of one and analogously if
 you were asked what does it mean to imagine casteling
 etc. the king of chess, a pawn, a
 knight's moove
 etc.. 
 But what if you explained: But shal 
 Or should you have said: He must go through certain
  … . 
 But will any what private experiences are there & will any
 of them do in this case? 
 For 18
  instance
 feeling hot? 
 But you don't understand me. No. “No!” 
 The private exp. I am talking of
 must have the multiplicity of the game of chess: But
 remember what we have said of again does he
 recognize two private exp. to be different
 by a further priv.
 exp. & this to be the
 [Priv.
 exp. in fiction.]
 ...
 even entitled to use the words experiences at all? 
 What makes us believe that we are is, that we really think of the
 case in which we can describe his priv.
 exp. describing different
 kind ways of playing chess in
 one's imagination.
 ...
 something like say, whether if he says he sees red he sees red
 & not perhaps blue green or yellow. 
 In which it alludes to a certain class of experiences which we know though
 we don't know which one of its members he has. 
  
  
  
   Rather  the  private experiences impressions
   which we imagine as the background to the foreground of our actions
   dissolves into a mist which we wished to refer to talk about
   ...
   w
    ...
    x a, y, z etc. behind our
    acti actions, loose their individualities &
 ...
 ‘t’ stands on the one hand for a
 ...
 But why should you talk of a priv.
 exp. & not 100
 priv. experiences, as you don't know
 ...
 ​  
 What does it consist in is it that
 happenisng is happening is it that
 happens when in one case I say “I have
 toothache see red & mean it, isn't &
 I am not lying, & I know what I'm saying,
 ...
 them?” – 
  ...
  For if as far as they are laid down For, being
 laid down … For in so far as
 ...
 ​  
 My criteria for having t are the same as saying I have t is no other than for the
 others saying I have t, for I
 can't say that feeling, or having,
 t. is my criterion for having a right to say
 it.
 ...
 pain”? 
 But showing t. can never be
  saying  …
 Ich glaube ich wollte zeigen, daß
 ‘t.’ hier nicht
 als Name eines Benehmens gebraucht ist gegeben wird & daß man
 auch nicht auf eine Erfahrung hinten dem Benehmen zeigt. 
  
 I must assume an expression which Iis not
 lying. 
 Now do I say that there wasis 
 
 20
  not the
 experience of t. but only the behaviour?!? 

 

 ​  
 When I say that moaning is the expression of
 t. then under certain
 circs. the idea possibility of it
 ...
 ​  
 The language games with expressions of feelings are
 ...
 ​  
 “But was I when a baby toaaught that
 ...
 as a normal child when it has t. &
 not have t.?” 
 ...
 But does if we speeak of the baby, ‘having
 t.’ mean the same as
 ‘behaving such & such’?
 ...
 ​
 You ought I suppose to say that you pity it because you believe that it
 has pains. 
 ...
 other; but that it depends on such things as ⌇ whether
 I say it in this or that tone of voice with a
 certain tentsion or without?”
 ⌇ 
 So that roughly speaking the sentence is true if it
  rings true    
 ...
 It is important here  that there
  is no  such case as that I exclude the case of  saying the untruth by
 mistake. 
 ...
 was did he know that he was lying or not? 
 ...
 lying? 
 Is there a criteriumon?
 

 

 ​ 
   Do these Are  these two sentences to Do these two sentences Are  these two sentences to  say the same thing: “He saiys he sees red &
 really sees red” & he saiys he sees
 ...
 seeing it might be saying it in a certain particular tone of
 voice. 
 ...
 speaking the truth) b) lying. 23 

 

 ​ 
 
 But one might call it lying to onesself if one
 e.g. turns one's watch forward to
 make oneself believe get up
 earlyier.
 ...
 ​ 
 When in this discussion we talk of lying it ought always to mean lying
 to onesself subjectively lying &
 by subjectively lying to the other person & not to
 onesself.

 

 ∕∕   
 If I see green without saying where “I see
 ...
 He allways , lyinglies, calling red
 ...
 seeing red or the su private experience of feeling a certain
 tentsion?
 ...
 charackterisiert ist daß ich mir bewußt bin daß es sich
 anderes 
 24
  verhält,
 & manchmal nicht inso, sondern dadurch, daß ich die
 ...
 würde.” 
 Aber das heißt doch (wohl) wahrheitsgemäß
 so bezeichnen würde. 
 Oder können wir sagen, “für sich so bezeichnen
 würde”? 
 Daher ja die Idee daß man lügen kann indem man laut das eine &
 ...
 ausdrücken könnte.” 
 Was ist das cKriterium dafür daß, er
 das es könnte?

 

 ∕∕  
 Was soll es dann heißen: einen Farbeneindruck wahrheitsgemäß
 mit ‘rot’ bezeichnen? 
 ...
 subjecktiver Wahrheit der Farben sprechen.
 ...
 erfährt // .” 
 Könnte es auch umgekehrt sein?  25
 ...
 ‘Reaktion’ schon etwas da, nämlich eben das
 ...
 ​
 “How am I justified in saying to myself that I
 see this apple as red”? 
 ...
 ​ 
 How is a lyie possible in a case where there is no
 justification?
 ...
 ​ 
 I am justif. if the word comes in
 one way, & not justif. if it comes
 in an other way. 
 –But in which way? – 
 ...
 un ‘feeling unjustified’, or
 ‘seeing green’ etc.” – 
 “But suppose that I call the feeling of being justified
 “feeling
 unjustified”!?” – 
 This Now this last sentence though it sounds absurd
 had sense.

 

 ∕∕   
 “What you say comes to this: that when
 you I truely say that
 ‘I see red’ you are I am not
 justified in saying this by the a fact
 that you I see red”. – 
 No I should say ‒ ‒ ‒
 ...
 expl. come to the same or do they
 describe different facts? 
 We might may can say: if they
 ...
 red” & having stomachh ache but
 as stomach ache is a priv.
 sens. why not rather consider the
 priv. sens. of
 just seeing green a colour other than red?) 
 We may say therefore that these explanations for our purpose were no
 explanations at all. 
 They left us just 
 27
  where we
 were before, and they only (seem) (to)
 confirm affirm say that the cases of lying
 & saying the truth are distinguished by the private
 experiences accompanying the sentence. 
 So let' us say ask put our
 questions like this: lying in our case consists in
 saying “I see red” & seeing green,: What does seeing green consist in?
 
 As an answer we immediately give ourselves a sample of green ‘for green’. 
 ...
 etc.. 
 But wou are you inclined to say “it might be what
 they call hot, cold or tepid”? 
 Then after all you are thinking of games played with
 the others though you left a certain latitude  … .

 

 ∕∕  
 When we talk of the private experience which the
 others don't know we originally ⇄ don't originally ⇄ don't don't originally
 ...
 object I can never know what colour the other really sees. 
 But with what 
 
  right do
 we here speak of use ‘colour’
 & seeing? 
 Some philosophers like (e.g.
 Driesch) would here be inclined to
 think that they can solve the puzzle save the
 situation by using the senseless phrase “We
 can't know what they other
 haves”. 
 Compare Driesch:
  … . 
 But the word ‘to have’ could here only help us if it
 had no meaning at all & then it couldn't help
 us. 
 But as long as ‘to have’ here has any meaning at all it
 ...
 that means: We some times sometimes use the expression
 “I lied when I said that I saw green”
 sometimes as opposed to “I told the
 truth when I said ‘ … ’”. 
 But isn't this enough? – 
 “But under what circumstances do you use the expression
 ‘ … ’”? 
 But must I necessarily stopp giving you circumstances with
 ...
 The word lying is taught us in a part way in
 which it was fastened to a gr certain behaviour to the use
 of a certain expression under certain circumstances. 
 Then we use it saying that we have been lying when we our have
 noticed it behaviour was not the one like the one which first
 constituted the meaning. ∕∕  
 Just in the same way we were taught the word
 ‘red’ in a game say like No1 & then we use it when the conditions are different
 (compare the past in the description of a dream) (and of course it
 ...
 ‘I see red’ but not an impression corresponding to
  it.” 
 On the contrary I too distinguish between don't say that
 ...
 it's raining. 
 So after all you'll have to give descriptions of what
 it is that happens you mean is happening & insofar
 as you give a description of it you must know what it is that
 happens & it is not an the
 x. 
 And keeping it partly unknown doesn't help you either. 
 On the other hand there is no reason why you should und
 always stopp with giving a sample & not with giving
 ...
 franck to with ourselves,
 & is, insoluble. 
 That is 1 That is untill
 ...
 not!” – You are
 first now obsessed with the
 word the use of the word
 ‘lying’. 
 As a rule In general you talk without thinking
 of lying & of whether you lyie or
 not.
 ...
 ​ 
 [Is there always a link between reality & our
 expressions?]
 ...
 shouldn't the child be able it be so with the
 child? 
 ...
 have”. – 
 The first sentence allready is misleading: It
 isn't the question whether I can moan with
 & without toothache, but the point is that I
 ...
 distinction. 
 In fact we don't. 
 We teach the child theo use the words “I have
 ...
 t. to mean what they wanted me to
 express? 
 I ought to say I believe I have
 t.? 
 Now one can moan because one has pains or, or
 ...
 ∕∕   
 “But “Do you mean that you can define pain
 in terms of behaviour?” 
 But is this what we do if we teach the child to use the expression
 ‘I have toothache’? 
 Did I say define: “Toothache is such
 & such a behaviour”? 
 This would obviously be entirely against This
 obv. contradicts the normal use of
 thise word! 
 ...
 ‘toothache’. 
 Pointing to the place of your pain & saying “this is
   … ”?” 
 Can't I give a name to the pain
 I've got? 
 Queer idea to give one pain a name! 
 What's it to do with a name? 
 ...
 ‘moo’. 
 “So what?” 
 Remember what we said about priv. ost. def.
 ...
 31
  I
 desc say what the world was is
 if I the realm of ideas has no neighbour. 
 ...
 visual geometrical eye, saying this. 
 ...
 And consciousness not physiologically understood; but or, understood
 ...
 ‘toothache’ –  like this? 
 The child sometimes has t. it moans
 & holds its cheek, the
  grown -upps say “ … ”
 etc.. 
 ...
 ​ 
 ‒ ‒ ‒But why shouldn't I say “I have
 t. in his tooth”. 
 ...
 ​  
 A lang. game in which everybody
 calls out what he sees but without saying “I see
  … ”. 
 Could anybody say that what Th I call out
 ...
 is mostly a small man with gray tflannel trousers in
  fact L.W.”. – 
 If Someone might answer me to this: It is
 true 
 33
  you
 you almost always weare gray flannel
 trousers & often look at them.

 

 ​ 
 “Ich bin doch befvorzugt. 
 ...
 geometrical eye this is on the same level as saying that I see in the
 ...
 allowed to say it & what are the reactions to
 this statement are to be what are the reactions to this
 ...
 but not L.W., but the person at the source of the
 vis. field. 
 ...
 nor to myself? 
  What is the criteriumon of saying it to myself?
 ...
 ​ 
 Der Solipsismus  // Die Auffassung des
 Solipsismus //  erstreckt sich nicht auf Spiele. 
 Der Andere kann so gut Schachspielen, wie ich kann
 Schachspielen so gut wie ich.  
 I.e., when we play a
 lang. game we are on the same level.
 ...
 person man in the place have more money than anyone
 else.
...
All I do is that alternately I point in front of me & to
 ...
 ​
 But sure what I now see, this room this view of my
 room, plays a unique role, it is the visual world! 
 (Der Solipsist flattert & flattert in der Fliegenglocke,
  schlägt sich an  den Wänden, flattert weiter. stößt
 sich an den Wänden, flattert weiter. 
 ...
 bringen?)
		 ...
		 ​ 
 You use “‒ ‒ ‒ Description: this 
 is what I now see”. 
 Leave out the “see”, leave out the
 “now”, leave out the “this”
 & leave out the “I”.
 ...
 it, I whether I or one of the others?
 ...
 (Isn't this similar to thinking that when things in
  space spactial things have changed entirely there's
 ...
 hand I see? 
 This is ridiculous. 
 Then either nobody is favoured or I am, that is then person
 L.W. whose hand
 is lifted.
 ...
 (The question ought to have been what are you now looking
 at). 
 I don't tell myself what it is I see by
 looking at seeing my finger pointing to
 what something.

 Suppose I said: “What I now see
 justif. me in saying “I see
 red” because it is the same colour as this sample”,
  
  this is a
 justific. only if I use the
 word expression “the same colour”
 in a fixed way. 
 That is when we judge how this word is used on the ordinary grounds of
 behaviour etc.
 ...
 ​ 
 What would I say if I cam in my
 priv. judgements came into contradiction with
 all other people. 
 I.e. if I could no  longer play a
 lang. game with them. 
 ...
 convinced sure that I was that I would stick to
 what I said whatever anyone else anyhow say.” 
 Under what circ. would we say that he
 did what we call portraying & under what
 circ. that he called something
 portraying which we didn't call that? 
  Suppose here we said: Well I can never know what he does inwardly
 ...
 ​  
 We call something a lang. game if it plays
 ...
 ​ 
 Under what circumstances would do I say I am
 entitled to say that I'm seeing red. 
 The answer is showing a sample i.e. giving the
 rule. 
 But if now I came into obvious constant
 ...
 game. 
  I.e. That is: is all that is necessary that the rule
 ...
 ​  
 If the “he has the having the
 same pains” means the same as
 “he saiys saying
 that he one has the same pains”
 then “I have the same pain” means the same as “I
 say that I have the same pains” & the exclamation
 ‘oh!’ means “I say
 ‘oh!’”.
 ...
 t. but without expressing
 it?” 
 “If it is possible that sometimes one can have
 ‘t.’ without expressing it,
 ...
 ​ 
 “Only he knows whether he has t.,
 we can never know.” 
 ...
 ​
  ...
  We aren't lying are speaking the truth
  
  
  if a fact corresponds to the sentence. 
 ...
 kind,  that the demonstration of ‘I see
 red’, ‘I have t.’
  seems indirect. to be a demonstration. in a different
 sense than the term of 
   
 If I say we must assume an expression which can't lie this
  can't be explained by saying, that really
 pain really pain pain really corresponds to this
 expression.
 ...
 same sense a description of my experience of my pain! 
 The one so to speak the description of an external the other of an
 internal fact. 
 This corresponds to the idea that it in the sense in which I can give
...
I can give a name to a private experience (only
 ...
 word t. is from teaching the word
 tooth. 
 ...
 t.” with the
 corresponding doubtfull uncertain tone of
 voice. 
 This mode of expr. could be
 ...
 Imagine here a typical case of a lyie. 
 ...
 one?” – 
 But what if I said that by facial expr.
 of shame I meant what you mean by the fac.
 exp. & the feeling, unless I
 ...
 behav. & nothing
 besides. //  
 We just mistake misunderstand / get the
 ...
 ​
 The Surely the descr. of
 the facial expr. can be meant
 (used) is used as a description of feelings & can
 be meant used otherwise. 
 In a story we often We constantly used such
 ...
 In other cases we describe the acting of a person in the same words or
  again we wish to leave it open whether the expression was genuine or
 not. 
 To say that a description of feelings of expressions used as a
 description of feelings is indirect we describe the feeling indirectly
 by the descr. of expressions is
 wrong!

 

 ​
 Imagine a lang. in which toothache is
 ...
 People would not say in this lang. that it
 ...
 doesn't omit anything & is as complete as
 though we had said that he really was angry, – but somehow the meaning
 of the expression then goes beyond reaches
 below the surface.
 ...
 But how could this explanation reach 
  ...
  under
 the surface? 
 It is an explanation about symbols signs
 ...
 correspond just to a picture, not to its
 usage. 
 It is just as misleading to say that there is nothing
 but just surface & nothing underneath it
 as that there is something below the surface & not that there
 ...
 are  judged by the ordinary criteria, 
 truths. 
 He saiys that he has been to school feeling that
 it's a lyie but the teacher & the boys
 confirms that he has been etc.
 etc.. 
 You might say: “But surely he can't
 be in doubt that he said a subjective
 lyie”. 
 But suppose he said “I've been to
 school”  
 This of course is like saying that he can't be in doubt
 about whether he has toothache or whether he sees red
 etc. 
  On the one hand: doubting whether I have the experience E
 is not like doubting whether someone else has it. 
 Remember what we said about the assymmetry of the
 game №  1. 
 On the other hand 
 
  one
 can't say that “surely I must know what it
 is I see” for unless to know what I see is to mean to see
 whatever I see. 
 ...
 normal eye & analogous ones of course don't
 interest us here.) 
 I suppose that to the knowledge of what it is I see must
 ...
 expression a word of a lang.
 game. 
 And doubting what it is I see will be is
 doubting what lang. game to
 play e.g. what to call what I
  see. 
 But there may be very different cases of this. 
 I may just ‘have forgotten the name of the
 colour’. 
 This means 
 42
  that I can
 find it out by asking someone what is this colour (pointing)
 called. 
 But this isn't an interesting case. 
 Doubting e.g. whether to say “I see
 red” or “I see green”. 
  “But this is a simple doubt about the appellation of a colour
 & it can be settled by asking someone what this colour
 (pointing) is called”. 
 But are all such doubts doubts about what people removable by this
 ...
 see.” – 
 “What on earth do you mean What do you
 mean? 
  Is the colour constantly changing, or do  you see it so very faintly,
 practically black?” 
 Now Could I say then: “don't
 you see what you see?” 
  I tThis obviously would make no sense.

 

 ​ 
 Colour: black red &
  white blue chequered. 

 

 ​ 
 “What colour do you call: a, e, i, o or
 u?” – 
 ...
 ​ 
 Is there a reason for not admitting brown as a primary
 colour? 
  Is it not enough that we refuse to group it with red, blue, green,
 etc.?

 

 ​ 
 One sometimes thinks the reason is that we see transitions from brown to
 ...
 ​ 
   Imagine all objects around us where irridescent, I mean of the appearance
 of a white surface paper on which the sun is
   shining, you would see the surface covered with tiny specks of red
   blue green yellow.

 

 ​ 
 Shall we say that a pointillist sees the objects as he paints
 them?

 

 ​ 
 It seems as though, however the outward
 circs. change, once the 
 43
 ...
 To say that I can't doubt whether to sayI see red is
 in a sense absurd as the game I play with the expression “I see
 red” doesn't contain a doubt of this form.
 It seems, – whatever the circumstances I always know now whether to
 ...
 (This reminds one of the way the idea of length seems to become
  emancipated from any particular method of measuring it.) 
 

 

 ​ 
 We are tempted to say: “damn it all, a rod has a
 ...
 say: I always know whether its
  looks its
  it looks tiny or big!   
 

 

		 /   
		   But can't the old game loose its
 point when the circs. change, so
 that the word expression ceases to have a
 meaning although of course I can still pronounce it.

 

		 /   
 He sticks to to saying that he has been lying although
 none of the normal consequences follow. 
 What is there left of the lang. game,
 except that he saiys the expression?

 

 ∕∕   
 We learn the word ‘red’ under
 part.
  circs. 
 Certain objects are usually red & keep their colour, most people
 ...
 ∕∕   
 The situation in which we are inclined to say “I must have gone
 mad!”

 

 ∕∕   
  “But we could always call a colourimpression
 ‘red’ & stick to it this
 application!” 

 

 ​ 
 Die Atmosphäre man die dieses Problem umgibt ist
 schrecklich. 
 Dichte Nebel der Sprache sind um den problematischen Punkt
 gelagert. 
 Es ist beinahe unmöglich dazu zu kennen zu ihm
 vorzudringen.

 

 ​ 
 Suppose I said had before me drawings of what I & other
 ...
 ​ 
 If I can speak about ‘what is seen’, why
 ...
 concsidering they would as much know what I see as
 my hand can wrigte down what my mouth can say.
 ...
 ​ 
 “This picture is  unique, for it represents what is
 really seen”. 
 ...
 ​  
 I see two spotts on this wall & lift two
 fingers. 
 Do I tell myself that I see two spots? 
 But on the other hand couldn't this be the sign that for
 my seeing two spots?! 
 ...
 ​ 
 “Today he points to me, & yesterday he pointed
 to me also.”

 

 ​  
 The meaning of: “He points toat
 me”. 
 ...
 ​ 
 You seem to be able to give yourself a sort of ostensive
  explanation
  
 
 tion of
 what the word expression “What is seen” refers
 to.

 

 ∕∕   
 Imagine a game: a group of people tell each other A
 tells B what B sees B tells A what A sees
 ...
 This game could be like is more instructive if we imagine the
 persons not to say what is seen but to paint it or to make models of
 it. – 
 Now let me imagine that I am one of them. pl.
 the players. 
 ...
 ​ 
 Frage Dich: Kann das ↗) nur ich
 sehen, ober kann es auch ein Andrer sehen? 
 46
 ...
 ​ 
 Für mich existiert kein Unterschied zwischen ich &
 das↗; & das
 Wort “ich” ist für mich kein Signal, das einen Ort
 oder eine Person hervorhebt bezeichnet  // eines Orts oder einer
 Person // .

 

 ​ 
 Ich versuche das ganz Problem auf das
  nicht verstehen 
 ...
 ​ 
 When I stare am at a coloured object
 ...
 ​
 It is as though there was a magic power in the words
 “this is … ”.

 

 ​ 
 I can bring myself to say: There is no toothache there
 ↗ (in the
 ...
 ​ 
 Suppose I give this rule: “Whenever I said
 ‘I have t.’, I shall from
 now on say ‘there is
 t.’”.
 ...
 ​ 
 I tell the waiter bring me always clear soup & thick soup to
 the others. 
 ...
 it was I who   asked for clear soup”, – couldn't I be
 wrong? 
 Certainly. 
 ...
 him? 
 I say: “I remember having asked  you
 ...
 ​ 
 It seems that I can trace my identity quite independent of the
 identity of my body. 
 ...
 “If anybody asks me to describe what I see, I describe
 what's seen.”
 ...
 ​ 
 If I speak of a description of my sense datum I don't
 mean to give a particular person as its
 possessor. 
 ...
 ​ 
 It must be a serious & deepseated
 deisease of language (one might also say ‘of
 ...
 ​ 
  ...
  I can tell you the fact p  because I know that p is the
 case. 
 But It has sense to say “it rained & I knew
 ...
 Examine the
 prop. sentence statement: “There is something there”, referring
 ...
 ​ 
 Compare with this such a statement as: “surely of course I know what I am referring
 to by the word toothache”.

 

 ​ 
  Think of the state frame  of mind   
  mental state
   in
 ...
 ​
 But now consider the case of someone having a picture before him of the
 part of his room he is seeing & that he's
 saying: “this in the picture is like this (a
 part of his visual field, as he is looking at his
 room).”
...
For I just expressed myself in our
 ordinary form of expression.
...
he ⇄ even he ⇄ even he ⇄ even even he

he ⇄ even

he ⇄ even he ⇄ even even he
...
which we both see  // which both of
 us see //  which I  & he see
...
particular
		 process certain (private) experience

particular
		 process

certain (private) experience
...
(Still contradicting objecting)

contradicting objecting
...
you say to yourself ‘seeing red is
 this’
...
talk of use the formal expression
...
I have no justification whatever to
 use there is no justification whatever for using
...
remember what we have said of again
...
For if as far as they are laid down
...
join
 the rest of what is thus laid down

are become just part
 of the common lang. game
...
can I say does it help me to say

can I say

does it help me to say
...
having t are the same as saying I have t is no other than

having t are the same as

saying I have t is no other than
...
in this or that tone of voice with a
 certain tentsion or without

in this or that tone of voice
...
that there
  is no  such case as that I exclude the case of

that there
  is no  such case as

that I exclude the case of
...
Do these Are  these two sentences to Do these two sentences Are  these two sentences to

Do these Are  these two sentences to

Are

Do these two sentences Are  these two sentences to

Do these two sentences Are  these two sentences to

Do these two sentences

Are  these two sentences to

Are

thing

with conviction and has the experience of not
 lying

with conviction

and has the experience of not
 lying
...
originally ⇄ don't originally ⇄ don't don't originally

originally ⇄ don't

originally ⇄ don't

originally ⇄ don't don't originally
...
it is that happens you mean is happening
...
as a picture) as much as a picture
 as a sample)
...
and now it uses these words under these
 circumstances
...
It is the thought which is It is
 that thought which is

It is the thought which is
...
is to be played I intend to be
 playing
...
what the reactions to this statement are to be
...
the people who
 hear it those to whom it is said
...
kann so gut Schachspielen, wie ich kann
 Schachspielen so gut wie ich

kann so gut Schachspielen, wie ich
...
am the wealthiest
 person man in the place

person

have more money than anyone
 else
...
schlägt sich an  den Wänden, flattert weiter.
...
aren't lying are speaking the truth
...
to be a demonstration. in a different
 sense than the term of
...
mode of expr. could be
 described by saying that we
...
a description of feelings of expressions used as a
 description of feelings is indirect we describe the feeling indirectly
 by the descr. of expressions

a description of feelings of expressions used as a
 description of feelings is indirect

of feelings

we describe the feeling indirectly
 by the descr. of expressions
...
how do we know whether he means
 it? what is to show that he means it?

how do we know whether he means
 it?

what is to show that he means it?
...
a group of people tell each other
...
das einen Ort
 oder eine Person hervorhebt bezeichnet

hervorhebt bezeichnet
