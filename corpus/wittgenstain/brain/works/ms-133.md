...
     Und kann man nicht doch sagen: “Ich sah den Ausdruck plötzlich so – so phrasiert –, da fiel mir die Ähnlichkeit mit … auf”?


		
 	 			 	
     Dieses das als das Sehen scheint manchmal ein Sinneseindruck, manchmal eine Bereitschaft das & das zu tun.
...
2
haben kann, wie ein Verändern des Gesehenen, z.B. durch ein Setzen von Klammern, ein Unterstreichen, Zusammenfassen auf die oder jene Art, etc., & daß das So-Sehen in dieser Weise wieder mit dem Vorstellen Ähnlichkeit hat.
...
 	 			 	
     Diese Beschreibung scheint plötzlich zu passen, dann jene! – Aber ist das nicht nur darum so, weil eben jetzt dies in irgendeinem Sinne da ist, dann jenes? In irgend einem Sinne. –
...
 	 			 	
     Das ‘Schachbrett’ einmal so, einmal so sehen hat anscheinend sehr geringe || ist von anscheinend sehr geringer Wichtigkeit. Und doch möchte man glauben, es müßte von der allergrößten Wichtigkeit sein. – Daß man das Schachbrett so & so auffassen kann, ist offenbar von der größten Wichtigkeit. (Die Mathematik beruht auf dieser Fähigkeit.) Aber ist ‘es so auffassen’ & ‘es so sehen’ das Gleiche? Muß wer es so auffassen kann, es so sehen können? Oder begünstigt das So-Sehen-Können das So-Auffassen-Können so-sehen, wie etwa die Existenz von Landkarten die Entwicklung
4
der Geographie.
     Darstellende Geometrie
		
 	 			 	
     Aber habe ich je von einem Mathematiker gehört, es sei dieses So-Sehen-Können eine wichtige Qualifikation || Befähigung des || eines Mathematikers. Habe ich je einen davon reden hören? Laboriere ich hier nicht unter einem Mißverständnis?
13.07.
		
 	 			 	
     Man könnte freilich das So-Sehen-Können zur Phantasie rechnen || zum Vorstellungsvermögen rechnen, & ¤ dies wird man gewiß ein Werkzeug || wichtiges Vermögen des Mathematikers nennen. || , & die gehört wohl zur Ausrüstung des Mathematikers || , & von ihr wird man nicht leugnen, sie gehöre zur Ausrüstung des Mathematikers.


		
 	 			 	
     Denke, es sei mir ein mathem. Ausdruck gegeben & ich schreibe ihn nun neu an mit neuen Klammern, etc., mit neuer Organisation.
– War es dagegen nötig daß ich zuerst den alten Ausdruck anders sah?
...
 	 			 	
     Könnte es nicht Menschen geben, die nicht im Kopf rechnen & nicht leise lernen könnten || können, dabei aber sonst sehr intelligente Menschen wären & in keinem Sinne ‘schwachsinnig’?
...
5
Wie kann das nicht von der größten Bedeutung sein?
     Z.B. sehe ich, wie man dies Schachbrett aus verschiedenen Bestandteilen zusammensetzen kann.
     Ich mache eine Art geometrischer Entdeckungen von der größten Wichtigkeit.
...
mit dem Sehen eines besondern Aspektes, nicht notwendigerweise immer mit dem Sehen des gleichen Aspektes.
...
 	 			 	
     Aber wie seltsam! könnte || möchte man sagen – Wenn man eine Art der Zusammensetzung entdecken kann, – wie ist es möglich sie auch zu sehen?! ‒ ‒ ‒ Wie ist es möglich, mit einem Schlage zu wissen, was man sagen will? Ist dies nicht ebenso merkwürdig?


		
 	 			 	
     Nehmen wir an ich hätte die Fähigkeit Aspekte zu sehen nicht, ein Andrer aber habe sie & mache dementsprechende Äußerungen: Was würde ich von ihnen denken, was könnte ich mit ihnen anfangen. Ich könnte sie etwa für eine Art || Äußerungen von Halluzinationen halten; aber das würde mich
6
nicht hindern von dieser Erscheinung Gebrauch zu machen, wenn sie sich gebrauchen läßt. Und wenn || soweit sie für den Andern nützlich ist, kann sie es für mich durch ihn sein.
...
 	 			 	
     Könnte der Aspekt durch eine Modifikation des Bildes erzeugt werden? Das modifizierte Bild könnte doch wieder so oder so gesehen werden! || . Und doch ist das nicht ganz richtig; denn sonst könnte man nicht ein Thema so hören & es dementsprechend spielen.
...
     Man sollte glauben, ein Aspekt könnte einer Auffassung nur günstig sein, nicht aber der Ausdruck der Auffassung der einzig mögliche || der wesentliche Ausdruck des Aspekts. || , nicht aber der Ausdruck der Auffassung wesentlich der Ausdruck des Aspekts. (Hier liegt die Analogie mit dem Vorstellungsbild einer bestimmten Person.)


		
 	 			 	
     Die Philosophie löst eine Schwierigkeit || ein Problem oft nur indem sie sagt: Hier ist so wenig eine Schwierigkeit, wie da.
...
 	 			 	
     Indem sie, also, ein || Nur also, indem sie ein Problem heraufbeschwört, wo keines war. || wo früher keines war.


		
 	 			 	
     Sie sagt: “Ist es nicht etwas merkwürdig, daß … ” & läßt es dabei || damit bewenden.
...
 	 			 	
     Wie befolgt man den Befehl “Stell dir N.N. vor!”? Wie weiß man daß der Befehl befolgt wurde? Wie
...
 	 			 	
     Es könnte sein, daß die Wissenschaft & Industrie, & ihr Fortschritt, das Bleibendste der heutigen Welt ist. Daß jede Mutmaßung eines Zusammenbruchs der Wissenschaft & Industrie einstweilen, & auf lange Zeit, ein bloßer Traum sei || ist & daß Wissenschaft & Industrie noch & mit unendlichem Jammer die Welt einigen werden, ich meine, sie zu einem Reich vereinigen || zusammenfassen werden, in dem || welchem dann freilich alles eher als der Friede
8
wohnen wird.
     Denn die Wissenschaft & die Industrie entschied doch die Kriege, oder so scheint es.
...
 	 			 	
     Die Figur als die ich die andere sehe, ist doch nicht eindeutig bestimmt. Denke Dir ein Dreieck im Film um  den Punkt1 schwingend dargestellt & dann stehenbleibend.
...
9
als eine Täuschung! & was bleibt, || : die Geneigtheit zu einem bestimmten Ausdruck! || .


		
 	 			 	
     Man möchte immer wieder vom Erlebnis, vom Privaten, als zu einem Gegenstand übergehen. || als || wie von einem Gegenstand Gebrauch machen. Daher will man's sich immer vergegenwärtigen. Es vor sich hinstellen. Man will es ins Auge fassen, & || – & darin liegt der Fehler, den wir machen.
15.7.
...
 	 			 	
     Wie kann etwas das Bild von Zinnen sein, d.h. als solches gesehen werden || sein?


		
 	 			 	
     Es scheint hier das Objekt des Sehens zu sein, was nicht Objekt des Sehens sein kann. Als sagte man, man sehe Töne. (Aber man sagt ja wirklich ein Vokal habe diese Farbe. || sei gelb oder braun.)


		
 	 			 	
     ¤Ich sehe, in einem Sinne, das:  oder das:  obwohl ich in einem andern Sinne wieder || beide Male das Gleiche sehe.
...
 	 			 	
     Wie könnte denn Assoziation ein Dauerzustand sein? Wie könnte ich denn fünf Minuten lang Zinnen mit diesen Strichen || Linien assoziieren?
...
 	 			 	
     Ich sehe doch dies als Schuh! Und nun möchte man die Schuhhaftigkeit
11
erfassen, vorführen, herausstellen, das Objekt des Sehens.


		
 	 			 	
     Die Lösung ist natürlich nicht: “Man kann eben auch solche Dinge, solche Objekte, wirklich sehen” – sondern: Das Wort “sehen” hat eine Verwendung, die || welche nicht dem von uns angenommenen Schema folgt.


		
 	 			 	
     Es sind falsche Vergleiche, die die Frage “Wie kann man … ” “Wie ist es möglich … ” hervorrufen || gebären || , die zur Frage zwingen “Wie kann man … ” “Wie ist es möglich … ” || , die uns in die Frage treiben “Wie kann man … ” “Wie ist es möglich … ”
...
 	 			 	
     Was überzeugt mich denn, daß der Andre ein gewöhnliches Bild dreidimensional sieht? – Daß er's sagt? Unsinn ‒ ‒ ‒ wie weiß ich denn, was er mit dieser Versicherung meint?2
...
 	 			 	
     Ich kann von ihm nicht || nie wissen, ob er wirklich sieht. Nun, dann kann ich's von mir natürlich auch nicht wissen. Denn wie weiß ich daß ich jetzt das Gleiche so nenne, wie früher, & daß ich das Gleiche “gleich” nenne!


		
 	 			 	
     “Mein Gesichtsbild organisiert sich: es formt || bildet sich ein Viereck & ein Stern in der Mitte (etc.). Ein andermal bildet sich eine homogene Masse von Feldern, etc. etc..”
...
13
Aber diese Erklärung meines Benehmens ist für mich || uns überflüssig. Ich nehme das Benehmen ebenso hin, wie einen Vorgang auf der Retina, oder im Gehirn.
     Ich will sagen: Die physiologische Erklärung ist zuerst scheinbar eine Hilfe, zeigt sich aber dann gleich als bloßer Katalysator der Gedanken. Ich führte sie nur ein, um sie gleich wieder loszuwerden.
...
 	 			 	
     Warum zieht man denn in einer geometrischen Zeichnung gewisse Striche stark aus, andere dünn, andere punktiert, etc.? Um die Übersicht zu erleichtern. Also um es mir leichter zu machen sogar nach der Zeichnung zu handeln.
...
     Aber warum sollten diese Spiele des Aspekts nicht gerade der Tätigkeit einen Reiz ausmachen? || geben? Auch das wäre möglich, aber es würde sich das Tun mit dem Aspekt doch irgendwie vermählen.
...
 	 			 	
     Das heißt, ich kümmere mich um alles mögliche, worum ich mich eigentlich || am Ende garnicht kümmern dürfte || darf. Denn die Lösung muß || müßte mir alles dies ersparen. ||
Denn die Lösung muß mir alle diese Überlegungen ersparen.


		
 	 			 	
     Denke die physiologische Erklärung erklärte das Reden vom Aspekt als einen Irrtum. Der Physiologe sagte: “Darum meinen die Leute, sie sähen das Schachbrett als dies Ornament. – Würde es so eine Erklärung nicht auch tun? würde sie nicht genügen?
     (“Darum meinen die Leute der || ein Vokal sei gelb …”)


		
 	 			 	
     Die physiologische Erklärung hat das Gute, daß sie unsere Aufmerksamkeit || unsern Blick von dem privaten || subjektiven Objekt des Sehens abzieht.


		
 	 			 	
     Denk nur ja nicht, Du wüßtest im vorhinein, was Bewußtseinszustand || Zustand des Sehens in diesem Falle bedeutet! Laß Dich die Bedeutung durch den Gebrauch || vom Gebrauch
15
lehren! || .
...
 	 			 	
     Hätte ich mir das Phänomen der Vorstellung erklären können? wenn man uns gesagt hätte || mir gesagt worden wäre, es sähe Einer mit offenen Augen etwas was nicht vor ihm ist & zugleich doch was vor ihm ist & doch || es störten sich die beiden Gesichtsobjekte nicht?! || & es wären die beiden Gesichtsobjekte einander nicht im Wege?!
...
 	 			 	
     Die alte Ansicht von der Rolle der Anschauung in der Mathematik. Ist diese Anschauung nicht eben
...
 	 			 	
     ‘Ich wußte, wie ich fortzusetzen habe? – Ich sagte es, & handelte dann so & so. Aber war || bestand nicht
16
doch auch jener Geisteszustand? Welcher? Ich weiß ja nur, wie ich ihn nannte. – Aber es war eben da nicht etwas, was ich so & so nannte. Die Wörter hatten einen andern Gebrauch!
17.7.
		
 	 			 	
     Muß man aber nicht doch unter den Aspekten rein optische von anderen unterscheiden?
     Daß sie untereinander sehr verschieden sind ist klar: Es tritt z.B. in ihre Beschreibung manchmal die dritte Dimension || die Tiefendimension ein, manchmal nicht; manchmal ist der Aspekt eine bestimmte ‘Gruppierung’, wenn man aber etwas || Striche als Gesicht sieht so hat man sie nicht nur visuell zu einer Gruppe zusammengefaßt; man kann die schematische Zeichnung eines Würfels als offene Kiste oder als soliden Körper sehen, auf der Seite
...
 	 			 	
     Man hängt Bilder, stellt Photographien auf von Landschaften, Innenräumen, Menschen, & gebraucht & betrachtet sie nicht als || wie Werkzeichnungen. Man liebt sie anzusehen, wie die Gegenstände selbst; man lächelt die Photographie an, wie den Menschen, den sie zeigt. Wir lernen nicht eine Photographie verstehen wie eine Blaupause. – Es wäre freilich möglich, daß wir eine Abbildungsart erst mit Mühe verstehen lernen müssen um sie später als natürliches Bild gebrauchen zu können. Dies mühsame Lernen wäre später nur mehr Geschichte & das Bild würden wir nun ebenso
17
...
 	 			 	
     Es könnte doch auch Menschen geben, die Photographien nicht, wie wir, verstünden, sähen; die zwar verstünden, daß auf diese Weise ein Mensch dargestellt werden kann, die ihn auch ungefähr nach einer Photographie modellieren könnten, die aber die Photographie doch nicht als Bild sähen. Wie würde sich das äußern? Was würden wir als Äußerung dafür || dessen betrachten?? Das ist vielleicht nicht leicht zu sagen.
     Diese Leute hätten vielleicht nicht Freude an Photographien wie wir. Sie würden nicht sagen “Schau, wie er lächelt!” & dergleichen; sie würden eine Person oft nicht gleich nach dem Bild erkennen; müßten die Photographie lesen lernen & lesen; sie hätten Schwierigkeiten
...
     Wenn mir jemand mitteilt: “Ich sehe es als verkehrtes F” – was kann ich damit tun? Ich könnte ihm etwa sagen: “Dann sieht es nicht kühn oder flott oder energisch aus, sondern: “dann stimmt es nicht zum übrigen Charakter der Schrift”, || . Es könnte aber für mich auch das lahme Aussehen verlieren & sozusagen ein ganz anderer Buchstabe werden, der auch wieder unenergisch aussehen kann.
18
		
 	 			 	
     Das Wort “Venus” habe ich früher immer so gehört wie “Walnuß”.3 Und auch jetzt hat es || die Endung noch einen Schatten davon an sich. In einem Gesicht, oder in ausdrucksvoller Prosa könnte das Wort einen richtigen || andern Klang für mich gewinnen, einen lateinischen Klang. Wenn ich dies Einem mitteilte, so könnte er manches daraus schließen, damit machen; aber es ist nicht ohne weiteres klar was.


		
 	 			 	
     Hat es Sinn zu sagen “Ich sehe  immer andauernd || ohne Unterlaß, als umgekehrtes F”? Das scheint nicht möglich zu sein. Wenn uns jemand das mitteilte, was sollten wir daraus machen? || Was sollten wir aus so einer Mitteilung machen? (Bemerkung James' über die Aufmerksamkeit.) Hier liegt noch eine völlige Unklarheit. Denn es scheint dann, als könnte man den Aspekt im Zusammenhang mit Gedanken, mit
einer Fähigkeit haben.


		
 	 			 	
     Wenn mir Einer sagte, er habe die Figur gar eine halbe Stunde lang ohne Unterbrechung als umgekehrtes F gesehen, so würde || müßte ich annehmen, er habe fortwährend daran || an diese Interpretation gedacht, sich damit beschäftigt.
...
 	 			 	
     Es ist, als wäre der Aspekt etwas, was nur aufleuchtet, aber nicht stationär bleibt || stehenbleibt; & doch muß dies eine begriffliche Bemerkung sein, keine psychologische.


		
 	 			 	
     Es kann eine Figur die ich immer für dies anschaute, plötzlich
19
für mich das werden, & es dann bleiben, aber das akute Erlebnis des Übergangs besteht dann nicht aus zwei aneinanderstoßenden Phasen, deren zweite nun einfach festgehalten wird.


		
 	 			 	
     ¤ Beim Umschnappen erlebt man die zweite Phase in akuter Weise (entsprechend etwa dem Ausruf “Ach, es ist ein … !”) & hier beschäftigt man sich ja mit dem Aspekt. Im chronischen Sinne ist er nur die Art & Weise, wie wir die Figur wieder & wieder behandeln.


		
 	 			 	
     Was teile ich jemandem mit, dem ich sage, ich habe das Wort “Bank” ausgesprochen & es in der Bedeutung “Sitzbank” gemeint?
...
 	 			 	
     Denn wir müssen bis zum Begriff der Mitteilung niedersteigen, um uns die Lage || den Status dieser Worte verständlich zu machen. || niedersteigen, & ihn betrachten, um das Problematische an dieser Mitteilung || diesen Worten loszuwerden.


		
 	 			 	
     Ich werde hier immer in Fragen verwickelt, die mich nichts angehen; muß mich aber in sie verwickeln lassen, um zu lernen, wie diese Verwicklungen zu vermeiden sind. || , wie diese falsche Lage zu vermeiden sei.
...
 	 			 	
     Köhler denkt ‘in terms of’ || mit den Begriffen der Vorgänge auf der Netzhaut & im Nervensystem. Er sagt, es könne eine Kontur nach dieser, oder nach der andern Seite gerichtet sein & erklärt es etwa durch Ströme, die so, oder so gerichtet sind. Und solange man physiologisch denkt, sind dann freilich Farbe, Form & Aspekt auf einer Stufe. Aber die physiologischen Vorgänge beim Sehen sind es nicht, die wir
21
...
 	 			 	
     Sagen wir so: Eine visuelle Kontur hat zwei nicht gleichberechtigte || ungleiche Seiten, die eine ist die positive, die andere die negative. Warum nicht? – Aber welches ist nun die Verwendung von “positiv” & “negativ”, wie zeigt es sich in unserm Benehmen, daß eine Seite positiv ist, etc.? Wie weiß ich, heißt das, daß der Andre “positiv” nennt, was ich so nenne? Spielt dabei die sonstige Rolle des Wortes || Funktion der Worte “positiv” & “negativ” eine Rolle.
...
 	 			 	
     Wenn es scheint, es wäre für diese || eine solche logische Form kein Platz, so mußt Du sie in einer anderen Dimension suchen. || aufsuchen. Wenn hier kein Platz ist, so ist er eben in einer andern Dimension. || Wenn es scheint es wäre für so eine Form zwischen den andern Formen doch kein Platz, dann || so mußt Du sie eben in einer anderen Dimension suchen. || aufsuchen.


		
 	 			 	
     Denn so fragt man: “Wie kann ich das Wort “Faß” in einer Bedeutung, oder in einer andern hören?” Und zu sagen “Es ist eben doch möglich – also hat dich ein Vorurteil gehindert es zu sehen” || also war es ein Vorurteil, es wäre nicht möglich” ist ganz irreleitend & zwar ganz so
als sagte man, die Mathematik habe uns vom Vorurteil befreit unser Raum müsse 3-dimensional sein. Denn zwischen drei Dimensionen & vier Dimensionen ist nicht der Unterschied wie zwischen 3 Äpfeln in einer Lade & vier Äpfeln in einer Lade. || , Es ist noch ‘für einen vierten Apfel Platz’ aber nicht für eine ¤ vierte Dimension. In diesem Sinne ist auch auf der Zahlenlinie nicht für imaginäre Zahlen Platz. Und ¤ das heißt doch: Die Anwendung eines imaginären Zahlbegriffs ist grundverschieden von der einer ganzen Zahl Anzahl, etwa; verschiedener, als die mathematischen Operationen allein es offenbaren. Man muß also, um Platz für sie zu gewinnen, zu ihrer Anwendung hinuntersteigen & dann finden sie einen, sozusagen, ungeahnt, verschiedenen Platz.
...
 	 			 	
     Wenn das Sehen eines Aspekts einem Gedanken entspricht, dann kann es nur in einer Welt || einem Reich von Gedanken ein Aspekt sein.



		
 	 			 	
     Wenn ich einen Aspekt beschreibe, so setzt die Beschreibung eine große Menge von Begriffen || Begriffe voraus, die nicht zur Beschreibung der Figur selbst gehören.
...
 	 			 	
     Es ist doch merkwürdig || Ist es nicht merkwürdig daß man bei der Beschreibung eines Gesichtseindrucks so ungemein selten das Wandern des Blicks in die Beschreibung einbezieht? Es wird so gut wie nie einbezogen, wenn der Gegenstand
24
...
 	 			 	
     Der Wechsel des Aspekts gibt jedesmal gleichsam ein Aufzucken eines Aspekts. || des einen oder des andern Aspekts. So wie unser Gesicht tatsächlich zuckt, sich erhellt, wenn wir ihn wahrnehmen || wenn er eintrifft. Und dies Eintreten muß nicht ganz plötzlich geschehen, es kann durch ein längeres Schauen, ein Deuten erzwungen || hervorgebracht werden.
...
 	 			 	
     Das Betrachten der Figur || Zeichnung als … Als ordnete man die Figur
...
 	 			 	
¤
     Der Aspekt kann plötzlich wechseln & es folgt dem Wechsel dann ein neues Betrachten. Man ist sich, z.B., des Gesichtsausdruckes bewußt, ¤ betrachtet ihn.
...
25
dabei vor?” sondern “Was tut man mit dieser Äußerung?”
20.7.
...
 	 			 	
Wie Köhler sagen will “Das zeigt, daß … ” sage ich: das zeigt gar nichts. Wenn man das Mittelmeer auf der Karte, bei anderer Kolorierung, nicht erkennt, so zeigt das nicht, daß hier wirklich ein anderer visueller Gegenstand vorliegt. Das || Es könnte das höchstens einen plausiblen || guten Grund für eine bestimmte Ausdrucksweise sein || abgeben. || Das könnte höchstens einen guten Grund für die & die Ausdrucksweise abgeben. Es ist eben nicht das Gleiche, zu sagen “Das zeigt, daß hier wirklich zwei verschiedene visuelle Objekte vorliegen” – & || zweierlei gesehen wird” – & unter diesen Umständen wäre es gut || besser von zwei verschiedenen visuellen Objekten || Gesichtsobjekten zu reden”.
...
 	 			 	
     Was sehe  ich wenn ich diese Figur einmal als etwas Stehendes, einmal als etwas Herabhängendes sehe! Es scheint unbeschreiblich. Dies war eben die Beschreibung. Und der Vergleich mit dem Sehen ist eben gefährlich. Und das müßte ich daraus lernen.
     Ja, es sind hier Analogien, aber auch begriffliche Verschiedenheiten.


		
 	 			 	
     Das Sehen einer Figur in einem
bestimmten Aspekt ist vergleichbar dem Hören eines Worts in einer bestimmten Bedeutung, insofern als es ist als hätten die Figur & das Wort den Keim einer bestimmten Verwendung || Anwendung in sich.
     Damit ist aber wieder nichts über eine physiologische Funktion dieses Wahrnehmens gesagt. Es zeigt das nicht z.B. daß dies ‘Sehen’ die Anwendung der Figur oder des Worts tatsächlich erleichtert; obwohl Erfahrung so etwas zeigen könnte.


		
 	 			 	
     Ich höre zwei Leute reden, verstehe || höre nicht, was sie sagen, höre aber das Wort “Bank”. Nun nehme ich an, sie sprächen von Geld. (Das kann sich als richtig oder unrichtig herausstellen.) Habe ich damit das Wort “Bank” in der Bedeutung gehört?
     Anderseits: Es sagt || spricht einer in einem Spiel doppeldeutige Wörter, ohne Zusammenhang; ich höre
27
“Bank” & höre es als || in der Bedeutung Geldinstitut. Es ist beinahe, als wäre dies letztere ein wertloses Überbleibsel des ersten Vorgangs.
...
Ich meine: warum sollen wir nicht “sehen” sagen wollen, obwohl der Vergleich mit dem Sehen in mancher Weise hinkt. || nicht stimmt. Warum sollen wir nicht von einer Analogie beeindruckt sein, zum Nachteil aller || von allen Verschiedenheiten. Aber darum kann man sich auch nicht auf die Worte der Äußerung berufen. || , sondern muß
...
 	 			 	
     Die Verwirrung in der Psychologie ist nicht (Köhler) dadurch || damit zu erklären, daß sie eine “junge Wissenschaft” ist. Ihr Zustand ist mit dem der Mechanik || Physik, z.B., in ihrer Frühzeit gar nicht zu vergleichen. Eher mit dem gewissen Zweige der Mathematik. Es besteht da nämlich einerseits eine gewisse experimentelle Methode, anderseits Begriffsverwirrung, sowie in manchen Reihen der Mathematik Begriffsverwirrung & || mit Beweismethoden. Während man aber in der Mathematik ziemlich sicher sein kann, daß ein Beweis von Wichtigkeit sein wird, auch wenn er noch falsch interpretiert wird || nicht recht verstanden ist, ist man in
28
der Psychologie der Fruchtbarkeit der Experimente durchaus nicht sicher. Vielmehr besteht in ihr Problematisches, & Experimente, die man für die Methode der Lösung der Probleme ansieht auch wenn sie an dem, was uns beunruhigt, ganz vorbei gehen.
...
 	 			 	
     Ich sehe z.B. plötzlich die Ähnlichkeit zwischen Sohn & Vater, oder ich erkenne Italien auf der Karte. Inwiefern sehe ich hier etwas Neues: D.h. nämlich: Inwiefern ist dies begrifflich mit dem Sehen eines neuen Gegenstands || Komplexes von Farben & Formen verwandt?


		
 	 			 	
     Es kommt z.B. in einer Figur die gleiche Form zweimal in verschiedenem Zusammenhang vor. Ich zeichne die Figur richtig ab || nach, habe also die beiden gleichen Formen gesehen, die Gleichheit ist mir aber nicht aufgefallen, sie habe ich nicht gesehen.
21.7.
		
 	 			 	
     Man könnte dazu verführt werden zu glauben, es gäbe eine bestimmte
29
Art & Weise, wie man Jahreszahlen ausspricht, einen bestimmten Ton oder dergleichen. Denn eine Zahl || Hausnummer wie 1854 kann für mich etwas Jahreszahlhaftes an sich haben.
...
     Das Phänomen ist zu vergleichen dem des plötzlichen Wiedererkennens einer Person nach längerer Abwesenheit.
30
...
     Und “sehen” heißt hier auch nicht “auf einen Schlag erkennen”. Denn es könnte wohl sein, daß jemand nicht im Stande wäre auf den ersten Blick die eine Figur in der andern zu sehen, daß er dies aber könnte, nachdem er das Enthaltensein der einen in der andern sozusagen stückweise erkannt hätte.
...
 	 			 	
     Teile ich ihm mittels der zwei || beiden Bilder mit, die eine Figur sei in der andern enthalten, oder, ich erkenne, daß es so sei, so teile ich ihm damit nicht mit, ich sehe die eine in der andern.
     Worin liegt der Unterschied der beiden Mitteilungen. (Ihr Wortausdruck muß sich nicht unterscheiden.)


		
 	 			 	
     Ich kann die Figur  nicht als eine Vereinigung von  &  sehen die zusammengeschoben sind, daß sie sich halb überdecken, so daß das mittlere || schwarze Feld gleichsam doppelt gilt. || ein oberes & ein unteres darstellt. Wenn nun Einer sagte, er könne es || die Figur so sehen, könnte ich es nicht verstehen? könnte ich es glauben? Sollte ich sagen, dies sei möglich – auch wenn mir derlei noch nie vorgekommen wäre || ist? Müßte ich sagen “Der meint eben mit “so-sehen” etwas andres als ich”? – Und wenn ich es nun
32
annähme, was wüßte ich nun, was könnte ich damit anfangen? (Eine physiologische Verwendung ist natürlich wieder möglich || vorstellbar.)
...
 	 			 	
     Es wäre || ist aber die Frage, || : warum die primitive Reaktion des Klopfens mit dem Finger ein Ausdruck des So-Sehens genannt werden soll. Ohne weiteres wird man sie doch so nicht nennen können. Nur wenn sie sich mit andern Ausdrücken vereinigt.
...
also z.B.: Jetzt erinnert mich die Figur an eine Tapete die ich einmal gesehen habe; jetzt an ein Tischtuch … ” etc. || Jetzt erinnere ihn die Figur an dies, jetzt an jenes.”
...
 	 			 	
⇒      Kann mich etwas eine halbe Stunde lang an das Tischtuch || diesen Gegenstand erinnern? Es sei denn, daß ich mich mit dieser Erinnerung beschäftige.
22.7.
...
 	 			 	
     “Ich weiß jetzt woran || an wen es mich erinnert”, sage es aber noch nicht.
34
...
 	 			 	
     “Es ist mir, || (wenn ich die Figur ansehe, || ) als sehe ich ein unvollständiges Ornament mit weißen Streifen …” Wie ist mir denn also, wenn ich ein unvollständiges Ornament sehe? – Was kann der Andre daraus lernen?
     Nun, es könnte mich doch || z.B. zu einer Zeichnung, einem Bild anregen. In diesem Falle, wäre das Sehen des Aspektes ähnlich dem einer Vorstellung, die durch die Figur angeregt wurde. Es könnte ein solches Sehen auch einer mathematischen Entdeckung vorangehen. Oder der Andre könnte aus meiner Äußerung nur entnehmen, daß ich ein müßiges Spiel der Vorstellung treibe.
...
Kommt das daher daß dies Phänomen einer gewissen primitiven Deutung unsrer Grammatik (Sprachlogik) entgegenkommt? So || Aus dem gleichen Grunde, wie man sich auch oft vorstellt, es müsse die Erinnerung an ein Ereignis ein Vorstellungsbild || inneres Bild sein, & wie ja so ein Bild gelegentlich manchmal wirklich existiert.


		
 	 			 	
     Wenn ich die Figur  einen schwarzen Ring nenne & die Figur  einen weißen Ring, – so ist es auffallend, daß es schwer oder unmöglich ist, die Figur  als das Ineinander eines weißen & schwarzen Rings zu sehen. Das könnte sich aus unsrer Unfähigkeit erklären, die Augen in der & der || bestimmter Weise zu bewegen; & es könnte gefunden werden, daß, wer im Stande ist die Augen so zu bewegen, jenen Aspekt sieht || erhält.
     Sage ich aber “Ich kann die Figur nicht so sehen”, so meine
35
ich nicht, ich könne || kann die Augen so nicht bewegen (selbst wenn dies die Bedingung für das Eintreten des Aspekts wäre || ist).


		
 	 			 	
     Wenn ich sage, es könnte gefunden werden, daß wer die Augen so bewegen kann, den || jenen Aspekt erhält, – so wird dafür das Zeichen sein, daß er uns sagt, er sehe die Figur so. Und was ist nun verbürgt uns nun, daß hier z.B. kein Mißverständnis ist? – daß er wirklich die Figur so sieht? || daß wirklich dieser Aspekt eingetreten ist? Gibt es hier ein andres Kriterium, außer seiner Versicherung? Sind wir genötigt, sie hier anzuerkennen? || anzunehmen?
...
 	 			 	
     So || Wie verschwommen auch mein Gesichtsbild sein mag, (so) muß es doch eine bestimmte Verschwommenheit haben, so muß es doch ein bestimmtes Gesichtsbild sein.
     Das heißt wohl es muß einer genauen passenden Beschreibung fähig sein, wobei eher die Beschreibung die gleiche Vagheit haben müsse wie das Beschriebene. – Aber nun schau || wirf einen Blick auf das Bild & gib eine in diesem Sinne passende Beschreibung!
36
...
 	 			 	
     Die Abbildung || Abbildungsweise, die sonst möglich ist, ist eben hier unmöglich || nicht möglich.
...
 	 			 	
     Wenn ich sage “Er hat sich im Park auf eine Bank gesetzt”, so ist es freilich schwierig dabei an eine Geldbank zu denken, sich eine vorzustellen; aber das beweist nicht, daß man sich sonst eine andere Bank || Sitzbank vorgestellt hätte.
...
 	 			 	
     Denk an mögliche Variationen der Bedeutung von “Beabsichtigen” z.B.
     Das Denken an die Absicht, das Äußern der Absicht, die Vorbereitungen zum Ausführen der Absicht.
...
     Sich unter ihnen zu bewegen ohne anzustoßen. Also die Wege zu kennen die vom einen zum andern führen, so daß man sich frei in ihnen || durch sie bewegen kann || Sich unter ihnen zu bewegen, ohne immer wieder gegen ein Hindernis zu stoßen || rennen. Also die Wege zu kennen, die durch sie hindurchführen. || ohne immer wieder gegen ein Hindernis anzurennen.


		
 	 			 	
     D.h., man muß die Verwandtschaften & Unterschiede der Begriffe beherrschen.
39
Wie man den Übergang von irgend einer Tonart in eine andere beherrscht, || von einer Tonart in die andere beherrscht, von einer || der einen in die andere moduliert. || Wie man || Einer den Übergang von jeder Tonart in jede beherrscht, von einer || der einen in die andere moduliert.
...
 	 			 	
     Ein Zeitalter, das fortwährend mit Erklärungen von Tatsachen || von Phänomenen präokkupiert ist, kann eine Tatsache nicht fest ins Auge fassen, wenn es nicht die Erklärung dazu hat. Es ist,
als könnte Einer || könnten Leute einen Felsblock nur dann klar || in aller Klarheit sehen, wenn er || sie seine Entstehung kennt || kennen.)


		
 	 			 	
     “Jetzt höre ich das als Nachsatz zum ersten Teil.” – “Du machst dabei wahrscheinlich gewisse Bewegungen, innervierst Muskeln zu gewissen Gesten, und dergleichen.” Darum handelt sich's nicht. Erstens weiß ich von diesen Bewegungen nichts; & wenn sie auch tatsächlich konstatiert || gefunden würden, so wäre dadurch meine Aufgabe nicht gelöst. Ich muß gerade diese möglichen Erklärungen ignorieren. (Denn auch wenn sie stimmen, müssen sie nicht stimmen.)
...
 	 			 	
     Wer sagt “Ich habe jetzt das Wort ‘Bank’ in der Bedeutung isoliert gesprochen”, der spielt ein gänzlich anderes Sprachspiel, als der, welcher mir mitteilt, er habe mit dem Wort in jenem Bericht, oder Befehl, etc., das gemeint.
     Und nun ist es also wesentlich oder unwesentlich daß er auch im ersten Falle das Wort “meinen” gebraucht. Ist es unwesentlich so kann man es vielleicht durch die Beschreibung einer Vorstellung ersetzen. Ist es aber wesentlich, dann ist das erste || das eine Sprachspiel sozusagen eine Spiegelung des zweiten.5
...
 	 			 	
     Schach in der Vorstellung mit dem Andern spielen: Beide Spieler spielen in der Vorstellung & stimmen miteinander darin überein, dieser habe gewonnen, dieser verloren. Denk Tennis so gespielt Sie können dann Beide aus dem Gedächtnis die Partie übereinstimmend reproduzieren, sie aufschreiben, erzählen, etc..– Denke Tennis so gespielt. Es wäre möglich. Nur natürlich keine Übung für die Muskeln. (Obwohl sich auch das denken ließe.) Wichtig ist daß man auch beim ‘Tennis in der Vorstellung’ wird sagen können “Es ist mir gelungen, den Ball …”.
...
41
Zug des Spiels gezeigt. Dennoch hätte ich geträumt: ich habe eine Partie Schach gespielt. Man wird dann sagen “Du hast sie nicht wirklich gespielt, Du hast es geträumt”. Warum sollte man nicht auch sagen “Du hast das Wort nicht wirklich so gemeint, Du hast es nur geträumt”?


		
 	 			 	
     Vor Gericht, z.B., könnte es eine Rolle spielen, || könnte die Frage gestellt || erörtert werden, || könnte es sich darum fragen, wie ich || Einer ein Wort gemeint hat || habe, & es kann auch aus gewissen Tatsachen || Zeugnissen geschlossen werden, wie ich || er es gemeint habe || hat || er habe es so gemeint. Es ist eine Frage der Absicht. Könnte aber auch jenes andere gleichsam gespielte || geträumte Meinen diese Wichtigkeit haben? || … Könnte die Frage erörtert werden, …
...
 	 			 	
     Weiter wollen wir natürlich nicht feststellen || untersuchen, was beim vorgestellten
Meinen vor sich geht.


		
 	 			 	
     Ich habe das Wort … ausgesprochen & es ist mir, als wäre || & mir ist, als wäre dabei das vorgegangen, was vorgeht, wenn ich es so meine.
24.7.
		
 	 			 	
     Aber wie ist es, – wenn || es: Wenn ich ein Gedicht, oder ausdrucksvolle Prosa lese, besonders wenn ich sie laut lese, so geht doch beim Lesen etwas in mir vor, was nicht vorgeht, wenn ich z.B. die Zeilen nur der || ihrer Information wegen überfliege. || , wenn ich die Sätze nur der || ihrer Information wegen durchlese || lese. Ich kann doch, z.B., einen Satz mehr, oder weniger eindringlich lesen. Ich bemühe mich den Ton genau zu treffen. Dabei geht oft auch ein Spiel der Vorstellungen vor sich || sehe ich oft ein Bild, gleichsam eine Illustration, vor mir. Ja, ich kann auch einem Wort einen Ton verleihen, der seine Bedeutung, wie ein Bild, beinahe, heraushebt. || , beinahe als wäre das Wort ein Bild, herumtreten läßt. Man könnte sich ja || selbst eine Schreibweise denken,
42
in der gewisse Wörter durch Bildzeichen dargestellt & so hervorgehoben werden. || durch bildliche Zeichnen ersetzt & so hervorgehoben werden. Ja dies geschieht ja wörtlich || doch manchmal, wenn wir ein Wort unterstreichen, oder es im Satz förmlich || gleichsam auf ein Postament stellen. [… “there lay a something …”]


		
 	 			 	
     Wenn ich beim ausdrucksvollen Lesen dies Wort ausspreche, so ist es sozusagen mit seiner Bedeutung gefüllt || ausgefüllt. Und nun könnte man fragen: “Wie kann das sein?”
